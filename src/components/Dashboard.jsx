...
export default function Dashboard() {
  ...
  return (
    <Box sx={{ display: "flex"}} className="MainContainer">
      ...
      <Drawer variant="permanent" open={drawerOpen} className="Drawer"sx={{backgroundColor:"fb6f92"}}>
        <DrawerHeader>
          <Avatar
            alt="User Image"
            src={userImage}
          ...
          />
          <h1
            style={{ marginRight: "auto", marginLeft: "2%", fontSize: "20px",color:"white" }}
          >
            {userName}
          </h1>
